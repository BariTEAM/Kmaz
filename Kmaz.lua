...
local TheKmaz = io.open("TheKmaz", 'w')
TheKmaz:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 Kmaz.lua
done
]])
TheKmaz:close()
...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S TheKmaz -X kill
screen -S TheKmaz ./TheKmaz
done
]])
Run:close()
Redis:del(SshId.."Info:Redis:User:ID");Redis:del(SshId.."Info:Redis:User");Redis:del(SshId.."Info:Redis:Token:User");Redis:del(SshId.."Info:Redis:Token")
os.execute('chmod +x TheKmaz;chmod +x Run;./Run')
end
...
TheKmaz = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..TheKmaz)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=TheKmaz,token=Token}
function var(value)  
...
Status = 0
DevelopersQ = Redis:sismember(TheKmaz.."Kmaz:DevelopersQ:Groups",UserId) 
if UserId == 733713096 then
Status = true
elseif UserId == 733713096 then
Status = true
elseif UserId == Sudo_Id then  
Status = true
elseif UserId == TheKmaz then
Status = true
...
Status = 0
Developers = Redis:sismember(TheKmaz.."Kmaz:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(TheKmaz.."Kmaz:DevelopersQ:Groups",UserId) 
TheBasics = Redis:sismember(TheKmaz.."Kmaz:TheBasics:Group"..ChatId,UserId) 
Originators = Redis:sismember(TheKmaz.."Kmaz:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(TheKmaz.."Kmaz:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(TheKmaz.."Kmaz:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(TheKmaz.."Kmaz:Distinguished:Group"..ChatId,UserId)
...
Status = Redis:get(TheKmaz.."Kmaz:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasics then
Status = Redis:get(TheKmaz.."Kmaz:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(TheKmaz.."Kmaz:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(TheKmaz.."Kmaz:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(TheKmaz.."Kmaz:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(TheKmaz.."Kmaz:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(TheKmaz.."Kmaz:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(TheKmaz.."Kmaz:lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(TheKmaz.."Kmaz:Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(TheKmaz.."Kmaz:Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(TheKmaz.."Kmaz:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(TheKmaz.."Kmaz:Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(TheKmaz.."Kmaz:Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(TheKmaz.."Kmaz:Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(TheKmaz.."Kmaz:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(TheKmaz.."Kmaz:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(TheKmaz.."Kmaz:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(TheKmaz.."Kmaz:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(TheKmaz.."Kmaz:Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(TheKmaz.."Kmaz:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(TheKmaz.."Kmaz:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(TheKmaz.."Kmaz:Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(TheKmaz.."Kmaz:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(TheKmaz.."Kmaz:Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(TheKmaz.."Kmaz:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(TheKmaz.."Kmaz:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(TheKmaz.."Kmaz:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(TheKmaz.."Kmaz:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(TheKmaz.."Kmaz:Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(TheKmaz.."Kmaz:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(TheKmaz.."Kmaz:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(TheKmaz.."Kmaz:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(TheKmaz.."Kmaz:Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(TheKmaz.."Kmaz:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(TheKmaz.."Kmaz:Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(TheKmaz.."Kmaz:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(TheKmaz.."Kmaz:Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(TheKmaz.."Kmaz:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(TheKmaz.."Kmaz:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(TheKmaz.."Kmaz:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(TheKmaz.."Kmaz:Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(TheKmaz.."Kmaz:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(TheKmaz.."Kmaz:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(TheKmaz.."Kmaz:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(TheKmaz.."Kmaz:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(TheKmaz.."Kmaz:Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(TheKmaz.."Kmaz:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(TheKmaz.."Kmaz:Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(TheKmaz.."Kmaz:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(TheKmaz.."Kmaz:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(TheKmaz.."Kmaz:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(TheKmaz.."Kmaz:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(TheKmaz.."Kmaz:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(TheKmaz.."Kmaz:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(TheKmaz.."Kmaz:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(TheKmaz.."Kmaz:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(TheKmaz.."Kmaz:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(TheKmaz.."Kmaz:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(TheKmaz.."Kmaz:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
BanAll = Redis:sismember(TheKmaz.."Kmaz:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(TheKmaz.."Kmaz:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(TheKmaz.."Kmaz:SilentGroup:Group"..ChatId,UserId)
}
end
...
return {
Lock     = '[- SOURCE KADI .](https://t.me/EKKKK6)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[- SOURCE KADI .](https://t.me/EKKKK6)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[- SOURCE KADI .](https://t.me/EKKKK6)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[- SOURCE KADI .](https://t.me/EKKKK6)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[- SOURCE KADI .](https://t.me/EKKKK6)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[- SOURCE KADI .](https://t.me/EKKKK6)\n*— — — — — — — — —\n᥀︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,TheKmaz).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(TheKmaz..'Kmaz:Channel:Join')
if Channel then
...
if tonumber(msg.sender.user_id) == tonumber(TheKmaz) then
...
elseif Redis:sismember(TheKmaz.."Kmaz:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(TheKmaz.."Kmaz:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(TheKmaz.."Kmaz:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(TheKmaz.."Kmaz:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(TheKmaz.."Kmaz:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي ⭐'
elseif Redis:sismember(TheKmaz.."Kmaz:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(TheKmaz.."Kmaz:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(TheKmaz.."Kmaz:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(TheKmaz.."Kmaz:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(TheKmaz.."Kmaz:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(TheKmaz.."Kmaz:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(TheKmaz.."Kmaz:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(TheKmaz.."Kmaz:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(TheKmaz) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(TheKmaz.."Kmaz:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(TheKmaz.."Kmaz:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheKmaz.."Kmaz:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(TheKmaz.."Kmaz:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(TheKmaz.."Kmaz:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(TheKmaz) then
return false
end
local floods = Redis:hget(TheKmaz.."Kmaz:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(TheKmaz.."Kmaz:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(TheKmaz.."Kmaz:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(TheKmaz.."Kmaz:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(TheKmaz.."Kmaz:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(TheKmaz.."Kmaz:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(TheKmaz.."Kmaz:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(TheKmaz.."Kmaz:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(TheKmaz.."Kmaz:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(TheKmaz.."Kmaz:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheKmaz.."Kmaz:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheKmaz.."Kmaz:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheKmaz.."Kmaz:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(TheKmaz.."Kmaz:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Distinguished then -- التوجيه
local Fwd_Group = Redis:get(TheKmaz.."Kmaz:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(TheKmaz.."Kmaz:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(TheKmaz.."Kmaz:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(TheKmaz.."Kmaz:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(TheKmaz.."Kmaz:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheKmaz.."Kmaz:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:incr(TheKmaz.."Kmaz:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(TheKmaz.."Kmaz:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(TheKmaz.."Kmaz:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(TheKmaz.."Kmaz:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(TheKmaz.."Kmaz:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(TheKmaz.."Kmaz:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(TheKmaz.."Kmaz:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(TheKmaz.."Kmaz:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(TheKmaz.."Kmaz:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(TheKmaz.."Kmaz:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(TheKmaz.."Kmaz:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(TheKmaz.."Kmaz:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(TheKmaz.."Kmaz:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(TheKmaz.."Kmaz:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(TheKmaz.."Kmaz:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(TheKmaz.."Kmaz:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(TheKmaz.."Kmaz:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(TheKmaz.."Kmaz:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(TheKmaz.."Kmaz:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(TheKmaz.."Kmaz:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(TheKmaz..'Kmaz:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(TheKmaz.."Kmaz:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(TheKmaz.."Kmaz:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(TheKmaz.."Kmaz:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(TheKmaz.."Kmaz:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(TheKmaz.."Kmaz:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(TheKmaz.."Kmaz:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(TheKmaz.."Kmaz:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(TheKmaz.."Kmaz:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(TheKmaz..'Kmaz:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(TheKmaz..'Kmaz:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(TheKmaz.."Kmaz:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(TheKmaz.."Kmaz:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(TheKmaz.."Kmaz:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(TheKmaz..'Kmaz:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(TheKmaz..'Kmaz:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(TheKmaz.."Kmaz:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(TheKmaz.."Kmaz:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(TheKmaz.."Kmaz:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(TheKmaz.."Kmaz:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(TheKmaz.."Kmaz:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(TheKmaz.."Kmaz:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(TheKmaz.."Kmaz:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(TheKmaz.."Kmaz:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(TheKmaz..'Kmaz:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(TheKmaz.."Kmaz:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(TheKmaz.."Kmaz:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(TheKmaz.."Kmaz:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(TheKmaz.."Kmaz:Command:List:Group"..msg_chat_id,text)
...
Redis:del(TheKmaz.."Kmaz:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(TheKmaz.."Kmaz:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(TheKmaz.."Kmaz:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(TheKmaz.."Kmaz:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(TheKmaz.."Kmaz:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(TheKmaz.."Kmaz:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(TheKmaz.."Kmaz:Command:Reids:Group:New"..msg_chat_id)
Redis:set(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(TheKmaz.."Kmaz:Command:List:Group"..msg_chat_id,text)
Redis:del(TheKmaz.."Kmaz:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(TheKmaz.."Kmaz:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(TheKmaz.."Kmaz:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(TheKmaz.."Kmaz:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(TheKmaz.."Kmaz:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(TheKmaz.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheKmaz.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(TheKmaz.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(TheKmaz.."Kmaz:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(TheKmaz.."Kmaz:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheKmaz.."Kmaz:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(TheKmaz.."Kmaz:Group:Rules" .. msg_chat_id,text) 
Redis:del(TheKmaz.."Kmaz:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(TheKmaz.."Kmaz:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheKmaz.."Kmaz:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
local test = Redis:get(TheKmaz.."Kmaz:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(TheKmaz.."Kmaz:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheKmaz.."Kmaz:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheKmaz.."Kmaz:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheKmaz.."Kmaz:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheKmaz.."Kmaz:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(TheKmaz.."Kmaz:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheKmaz.."Kmaz:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(TheKmaz.."Kmaz:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(TheKmaz.."Kmaz:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(TheKmaz.."Kmaz:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
print(idPhoto)
Redis:set(TheKmaz.."Kmaz:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ رد للمدير بنجاح \n᥀︙ارسل ( "..test.." ) لرئية الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(TheKmaz.."Kmaz:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheKmaz.."Kmaz:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(TheKmaz.."Kmaz:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(TheKmaz.."Kmaz:List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(TheKmaz.."Kmaz:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheKmaz.."Kmaz:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheKmaz.."Kmaz:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حذف الرد من ردود المدير ","md",true)  
return false
end
end
if text and Redis:get(TheKmaz.."Kmaz:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(TheKmaz.."Kmaz:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(TheKmaz.."Kmaz:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(TheKmaz.."Kmaz:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(TheKmaz.."Kmaz:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(TheKmaz.."Kmaz:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(TheKmaz.."Kmaz:Add:Rd:Sudo:Video"..text)
local document = Redis:get(TheKmaz.."Kmaz:Add:Rd:Sudo:File"..text)
local audio = Redis:get(TheKmaz.."Kmaz:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(TheKmaz.."Kmaz:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheKmaz..'Kmaz:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(TheKmaz..'Kmaz:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(TheKmaz.."Kmaz:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheKmaz..'Kmaz:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(TheKmaz.."Kmaz:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(TheKmaz.."Kmaz:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheKmaz.."Kmaz:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheKmaz.."Kmaz:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheKmaz.."Kmaz:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(TheKmaz.."Kmaz:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheKmaz.."Kmaz:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(TheKmaz.."Kmaz:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheKmaz.."Kmaz:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(TheKmaz.."Kmaz:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(TheKmaz.."Kmaz:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(TheKmaz.."Kmaz:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(TheKmaz.."Kmaz:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheKmaz.."Kmaz:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(TheKmaz.."Kmaz:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(TheKmaz.."Kmaz:List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(TheKmaz.."Kmaz:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(TheKmaz..'Kmaz:'..v..text)
end
Redis:del(TheKmaz.."Kmaz:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheKmaz.."Kmaz:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حذف الرد من ردود المطور","md",true)  
end
end
if Redis:get(TheKmaz.."Kmaz:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheKmaz.."Kmaz:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TheKmaz.."Kmaz:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(TheKmaz.."Kmaz:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(TheKmaz.."Kmaz:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(TheKmaz.."Kmaz:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(TheKmaz.."Kmaz:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(TheKmaz.."Kmaz:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(TheKmaz.."Kmaz:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(TheKmaz.."Kmaz:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(TheKmaz.."Kmaz:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(TheKmaz.."Kmaz:PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheKmaz.."Kmaz:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheKmaz.."Kmaz:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(TheKmaz..'Kmaz:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheKmaz.."Kmaz:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheKmaz.."Kmaz:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TheKmaz.."Kmaz:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheKmaz.."Kmaz:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheKmaz.."Kmaz:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheKmaz.."Kmaz:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheKmaz.."Kmaz:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(TheKmaz..'Kmaz:GetTexting:DevTheKmaz'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر ⌔' then 
Redis:del(TheKmaz..'Kmaz:GetTexting:DevTheKmaz'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم الغاء حفظ كليشة المطور')
end
Redis:set(TheKmaz..'Kmaz:Texting:DevTheKmaz',text)
Redis:del(TheKmaz..'Kmaz:GetTexting:DevTheKmaz'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم حفظ كليشة المطور')
end
if Redis:get(TheKmaz.."Kmaz:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء امر تعين الايدي","md",true)  
Redis:del(TheKmaz.."Kmaz:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TheKmaz.."Kmaz:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheKmaz.."Kmaz:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(TheKmaz.."Kmaz:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheKmaz.."Kmaz:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(TheKmaz.."Kmaz:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(TheKmaz.."Kmaz:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "᥀︙ تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(TheKmaz.."Kmaz:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheKmaz.."Kmaz:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(TheKmaz.."Kmaz:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(TheKmaz.."Kmaz:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "᥀︙ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(TheKmaz.."Kmaz:Game:Smile"..msg.chat_id) then
if text == Redis:get(TheKmaz.."Kmaz:Game:Smile"..msg.chat_id) then
Redis:incrby(TheKmaz.."Kmaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheKmaz.."Kmaz:Game:Smile"..msg.chat_id)
...
if Redis:get(TheKmaz.."Kmaz:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(TheKmaz.."Kmaz:Game:Monotonous"..msg.chat_id) then
Redis:del(TheKmaz.."Kmaz:Game:Monotonous"..msg.chat_id)
Redis:incrby(TheKmaz.."Kmaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(TheKmaz.."Kmaz:Game:Riddles"..msg.chat_id) then
if text == Redis:get(TheKmaz.."Kmaz:Game:Riddles"..msg.chat_id) then
Redis:incrby(TheKmaz.."Kmaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheKmaz.."Kmaz:Game:Riddles"..msg.chat_id)
...
if Redis:get(TheKmaz.."Kmaz:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(TheKmaz.."Kmaz:Game:Meaningof"..msg.chat_id) then
Redis:incrby(TheKmaz.."Kmaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheKmaz.."Kmaz:Game:Meaningof"..msg.chat_id)
...
if Redis:get(TheKmaz.."Kmaz:Game:Reflection"..msg.chat_id) then
if text == Redis:get(TheKmaz.."Kmaz:Game:Reflection"..msg.chat_id) then
Redis:incrby(TheKmaz.."Kmaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheKmaz.."Kmaz:Game:Reflection"..msg.chat_id)
...
if Redis:get(TheKmaz.."Kmaz:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(TheKmaz.."Kmaz:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(TheKmaz.."Kmaz:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheKmaz.."Kmaz:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(TheKmaz.."Kmaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(TheKmaz.."Kmaz:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(TheKmaz.."Kmaz:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(TheKmaz.."Kmaz:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheKmaz.."Kmaz:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(TheKmaz.."Kmaz:Game:Difference"..msg.chat_id) then
if text == Redis:get(TheKmaz.."Kmaz:Game:Difference"..msg.chat_id) then 
Redis:del(TheKmaz.."Kmaz:Game:Difference"..msg.chat_id)
Redis:incrby(TheKmaz.."Kmaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(TheKmaz.."Kmaz:Game:Example"..msg.chat_id) then
if text == Redis:get(TheKmaz.."Kmaz:Game:Example"..msg.chat_id) then 
Redis:del(TheKmaz.."Kmaz:Game:Example"..msg.chat_id)
Redis:incrby(TheKmaz.."Kmaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheKmaz..'Kmaz:Channel:Join')}, },}}
...
if tonumber(TheKmaz) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(TheKmaz..'Kmaz:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(TheKmaz.."Kmaz:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(TheKmaz.."Kmaz:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(TheKmaz.."Kmaz:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(TheKmaz.."Kmaz:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(TheKmaz.."Kmaz:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(TheKmaz.."Kmaz:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(TheKmaz) then 
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(TheKmaz.."Kmaz:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(TheKmaz.."Kmaz:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(TheKmaz.."Kmaz:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(TheKmaz.."Kmaz:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(TheKmaz.."Kmaz:TheBasics:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(TheKmaz..'Kmaz:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر ⌔' then 
Redis:del(TheKmaz..'Kmaz:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,TheKmaz).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(TheKmaz..'Kmaz:Channel:Join',ChannelUser) 
...
Redis:set(TheKmaz..'Kmaz:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheKmaz..'Kmaz:Channel:Join')
...
--os.execute('rm -rf Kmaz.lua')
--download('https://raw.githubusercontent.com/SourceTheKmaz/TheKmaz/master/Kmaz.lua','Kmaz.lua')
...
local Groups = Redis:smembers(TheKmaz..'Kmaz:ChekBotAdd')  
local UsersBot = Redis:smembers(TheKmaz..'Kmaz:Num:User:Pv')  
local Get_Json = '{"BotId": '..TheKmaz..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(TheKmaz.."Kmaz:TheBasics:Group"..v)
local Constructor = Redis:smembers(TheKmaz.."Kmaz:Originators:Group"..v)
local Manager = Redis:smembers(TheKmaz.."Kmaz:Managers:Group"..v)
local Admin = Redis:smembers(TheKmaz.."Kmaz:Addictive:Group"..v)
local Vips = Redis:smembers(TheKmaz.."Kmaz:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
listrep = Redis:smembers(TheKmaz.."Kmaz:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(TheKmaz.."Kmaz:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(TheKmaz.."Kmaz:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(TheKmaz.."Kmaz:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(TheKmaz.."Kmaz:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(TheKmaz.."Kmaz:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(TheKmaz.."Kmaz:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(TheKmaz.."Kmaz:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(TheKmaz.."Kmaz:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(TheKmaz.."Kmaz:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(TheKmaz.."Kmaz:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(TheKmaz..'Kmaz:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*᥀︙عدد احصائيات البوت الكامله \n— — — — — — — — —\n᥀︙عدد المجموعات : '..(Redis:scard(TheKmaz..'Kmaz:ChekBotAdd') or 0)..'\n᥀︙عدد المشتركين : '..(Redis:scard(TheKmaz..'Kmaz:Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(TheKmaz.."Kmaz:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TheKmaz..'Kmaz:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(TheKmaz..'Kmaz:Num:Add:Bot'),"md",true)  
end
...
{
{text = '『 𝗦𝗢𝗨𝗥𝗖𝗘 𝙍𝘼𝙐𝙈𝙊 』', url = 't.me/EKKKK6'},
},
}
}
if not msg.ControllerBot then
...
Redis:sadd(TheKmaz.."Kmaz:ChekBotAdd",msg_chat_id)
Redis:set(TheKmaz.."Kmaz:Status:Id"..msg_chat_id,true) ;Redis:set(TheKmaz.."Kmaz:Status:Reply"..msg_chat_id,true) ;Redis:set(TheKmaz.."Kmaz:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(TheKmaz.."Kmaz:Status:BanId"..msg_chat_id,true) ;Redis:set(TheKmaz.."Kmaz:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(TheKmaz.."Kmaz:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(TheKmaz.."Kmaz:ChekBotAdd",msg_chat_id) then
...
Redis:srem(TheKmaz.."Kmaz:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(TheKmaz.."Kmaz:ChekBotAdd",msg_chat_id) then
Redis:incr(TheKmaz..'Kmaz:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
if text == "ايدي" and msg.reply_to_message_id == 0 then
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheKmaz..'Kmaz:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n᥀︙عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end 
if not Redis:get(TheKmaz.."Kmaz:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(TheKmaz..'Kmaz:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(TheKmaz..'Kmaz:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(TheKmaz.."Kmaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(TheKmaz.."Kmaz:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(TheKmaz.."Kmaz:Set:Id:Group"..msg_chat_id)
if Redis:get(TheKmaz.."Kmaz:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(TheKmaz..'Kmaz:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(TheKmaz..'Kmaz:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*᥀︙ايديه : '..UserId..
...
local TotalMsg = Redis:get(TheKmaz..'Kmaz:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(TheKmaz..'Kmaz:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*᥀︙ايديه : '..UserId..
'\n᥀︙معرفه : @'..UserName..
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,TheKmaz).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,TheKmaz).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(TheKmaz.."Kmaz:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheKmaz.."Kmaz:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheKmaz.."Kmaz:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheKmaz.."Kmaz:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheKmaz.."Kmaz:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheKmaz.."Kmaz:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheKmaz.."Kmaz:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheKmaz.."Kmaz:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheKmaz.."Kmaz:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheKmaz.."Kmaz:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheKmaz.."Kmaz:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheKmaz.."Kmaz:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheKmaz.."Kmaz:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheKmaz.."Kmaz:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheKmaz.."Kmaz:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheKmaz.."Kmaz:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheKmaz.."Kmaz:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheKmaz.."Kmaz:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheKmaz.."Kmaz:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheKmaz.."Kmaz:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheKmaz.."Kmaz:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheKmaz.."Kmaz:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheKmaz.."Kmaz:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheKmaz.."Kmaz:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheKmaz.."Kmaz:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheKmaz.."Kmaz:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheKmaz.."Kmaz:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheKmaz.."Kmaz:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheKmaz.."Kmaz:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheKmaz.."Kmaz:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(TheKmaz.."Kmaz:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheKmaz.."Kmaz:Developers:Groups",UserId) 
...
if not Redis:sismember(TheKmaz.."Kmaz:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheKmaz.."Kmaz:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheKmaz.."Kmaz:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheKmaz.."Kmaz:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheKmaz.."Kmaz:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheKmaz.."Kmaz:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheKmaz.."Kmaz:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheKmaz.."Kmaz:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheKmaz.."Kmaz:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheKmaz.."Kmaz:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheKmaz.."Kmaz:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(TheKmaz.."Kmaz:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(TheKmaz.."Kmaz:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheKmaz.."Kmaz:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheKmaz.."Kmaz:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheKmaz.."Kmaz:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(TheKmaz.."Kmaz:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheKmaz.."Kmaz:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheKmaz.."Kmaz:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheKmaz.."Kmaz:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheKmaz.."Kmaz:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheKmaz.."Kmaz:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheKmaz.."Kmaz:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheKmaz.."Kmaz:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheKmaz.."Kmaz:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheKmaz.."Kmaz:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheKmaz.."Kmaz:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheKmaz.."Kmaz:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(TheKmaz.."Kmaz:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:Developers:Groups",UserId) 
...
if Redis:sismember(TheKmaz.."Kmaz:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheKmaz.."Kmaz:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheKmaz.."Kmaz:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheKmaz.."Kmaz:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheKmaz.."Kmaz:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(TheKmaz.."Kmaz:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(TheKmaz.."Kmaz:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheKmaz.."Kmaz:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheKmaz.."Kmaz:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(TheKmaz.."Kmaz:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheKmaz.."Kmaz:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(TheKmaz.."Kmaz:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(TheKmaz.."Kmaz:Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*᥀︙قائمه مطورين البوت \n — — — — — — — — —*\n'
...
local Info_Members = Redis:smembers(TheKmaz.."Kmaz:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheKmaz.."Kmaz:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheKmaz.."Kmaz:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheKmaz.."Kmaz:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheKmaz.."Kmaz:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheKmaz.."Kmaz:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheKmaz.."Kmaz:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheKmaz.."Kmaz:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(TheKmaz.."Kmaz:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(TheKmaz.."Kmaz:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(TheKmaz.."Kmaz:Status:Id"..msg_chat_id,true) 
...
Redis:set(TheKmaz.."Kmaz:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(TheKmaz.."Kmaz:Status:Reply"..msg_chat_id,true) 
...
Redis:set(TheKmaz.."Kmaz:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(TheKmaz.."Kmaz:Status:BanId"..msg_chat_id,true) 
...
Redis:set(TheKmaz.."Kmaz:BotFree",true) 
...
Redis:set(TheKmaz.."Kmaz:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(TheKmaz.."Kmaz1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(TheKmaz.."Kmaz1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheKmaz.."Kmaz1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheKmaz.."Kmaz1:List:Rd:Sudo"..msg.chat_id, text)
return  LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheKmaz.."Kmaz1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(TheKmaz..'Kmaz1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(TheKmaz..'Kmaz1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(TheKmaz..'Kmaz1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(TheKmaz.."Kmaz1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheKmaz.."Kmaz1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(TheKmaz.."Kmaz1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(TheKmaz.."Kmaz1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(TheKmaz.."Kmaz1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(TheKmaz.."Kmaz1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(TheKmaz.."Kmaz1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(TheKmaz.."Kmaz1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TheKmaz.."Kmaz1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheKmaz.."Kmaz1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheKmaz.."Kmaz1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheKmaz.."Kmaz1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheKmaz.."Kmaz1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheKmaz.."Kmaz1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheKmaz.."Kmaz1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheKmaz.."Kmaz1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheKmaz.."Kmaz1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheKmaz.."Kmaz1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheKmaz.."Kmaz1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheKmaz.."Kmaz1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheKmaz.."Kmaz1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(TheKmaz.."Kmaz1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(TheKmaz.."Kmaz1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(TheKmaz.."Kmaz1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(TheKmaz.."Kmaz11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(TheKmaz.."Kmaz11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheKmaz.."Kmaz11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheKmaz.."Kmaz11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(TheKmaz.."Kmaz11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(TheKmaz..'Kmaz11:Add:Rd:Sudo:Text'..text)
Redis:del(TheKmaz..'Kmaz11:Add:Rd:Sudo:Text1'..text)
Redis:del(TheKmaz..'Kmaz11:Add:Rd:Sudo:Text2'..text)
Redis:del(TheKmaz.."Kmaz11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheKmaz.."Kmaz11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(TheKmaz.."Kmaz11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(TheKmaz.."Kmaz11:Add:Rd:Sudo:Text"..v) 
Redis:del(TheKmaz.."Kmaz11:Add:Rd:Sudo:Text1"..v) 
Redis:del(TheKmaz.."Kmaz11:Add:Rd:Sudo:Text2"..v)   
Redis:del(TheKmaz.."Kmaz11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(TheKmaz.."Kmaz11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(TheKmaz.."Kmaz11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheKmaz.."Kmaz11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheKmaz.."Kmaz11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheKmaz.."Kmaz11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheKmaz.."Kmaz11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(TheKmaz.."Kmaz11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheKmaz.."Kmaz11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheKmaz.."Kmaz11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheKmaz.."Kmaz11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(TheKmaz.."Kmaz11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheKmaz.."Kmaz11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheKmaz.."Kmaz11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheKmaz.."Kmaz11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(TheKmaz.."Kmaz11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(TheKmaz.."Kmaz11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(TheKmaz.."Kmaz11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(TheKmaz.."Kmaz:allM"..msg.chat_id, msg.id)
if Redis:get(TheKmaz.."Kmaz:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(TheKmaz.."Kmaz:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(TheKmaz.."Kmaz:allM"..msg.chat_id)
...
Redis:del(TheKmaz.."Kmaz:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(TheKmaz.."Kmaz:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(TheKmaz.."Kmaz:allM"..msg.chat_id)  
...
Redis:del(TheKmaz.."Kmaz:Status:Del:Media"..msg.chat_id)
...
Redis:set(TheKmaz.."Kmaz:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(TheKmaz.."Kmaz:Status:yt"..msg.chat_id)
...
Redis:set(TheKmaz.."Kmaz:Status:yt"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم تفعيل اليوتيوب')
return false
end 
if text and text:match('^بحث (.*)$') and Redis:get(TheKmaz.."Kmaz:Status:yt"..msg.chat_id) then
...
if TextMsg == 'الرابط' then
Redis:del(TheKmaz.."Kmaz:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(TheKmaz.."Kmaz:Status:Welcome"..msg_chat_id) 
...
Redis:del(TheKmaz.."Kmaz:Status:Id"..msg_chat_id) 
...
Redis:del(TheKmaz.."Kmaz:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(TheKmaz.."Kmaz:Status:Reply"..msg_chat_id) 
...
Redis:del(TheKmaz.."Kmaz:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(TheKmaz.."Kmaz:Status:BanId"..msg_chat_id) 
...
Redis:del(TheKmaz.."Kmaz:Status:SetId"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تعطيل الرفع ","md",true)
end
if TextMsg == 'الالعاب' then
Redis:del(TheKmaz.."Kmaz:Status:Games"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تعطيل الالعاب ","md",true)
end
if TextMsg == 'اطردني' then
Redis:del(TheKmaz.."Kmaz:Status:KickMe"..msg_chat_id) 
...
Redis:del(TheKmaz.."Kmaz:BotFree") 
...
Redis:del(TheKmaz.."Kmaz:TwaslBot") 
...
if Redis:sismember(TheKmaz.."Kmaz:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheKmaz.."Kmaz:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(TheKmaz.."Kmaz:BanAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheKmaz.."Kmaz:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(TheKmaz.."Kmaz:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(TheKmaz.."Kmaz:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheKmaz.."Kmaz:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheKmaz.."Kmaz:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheKmaz.."Kmaz:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheKmaz.."Kmaz:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheKmaz.."Kmaz:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheKmaz.."Kmaz:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheKmaz.."Kmaz:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheKmaz.."Kmaz:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheKmaz.."Kmaz:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheKmaz.."Kmaz:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(TheKmaz.."Kmaz:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheKmaz.."Kmaz:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheKmaz.."Kmaz:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheKmaz.."Kmaz:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheKmaz.."Kmaz:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheKmaz.."Kmaz:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheKmaz.."Kmaz:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(TheKmaz.."Kmaz:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheKmaz.."Kmaz:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheKmaz.."Kmaz:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheKmaz.."Kmaz:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(TheKmaz.."Kmaz:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheKmaz.."Kmaz:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:get(TheKmaz.."Kmaz:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheKmaz.."Kmaz:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheKmaz.."Kmaz:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
Redis:set(TheKmaz.."Kmaz:Lock:text"..msg_chat_id,true) 
...
Redis:set(TheKmaz.."Kmaz:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(TheKmaz.."Kmaz:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(TheKmaz.."Kmaz:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(TheKmaz.."Kmaz:Lock:edit"..msg_chat_id,true) 
...
Redis:set(TheKmaz.."Kmaz:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheKmaz..'Kmaz:'..lock..msg_chat_id,"del")    
end
...
Redis:del(TheKmaz.."Kmaz:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(TheKmaz.."Kmaz:Lock:text"..msg_chat_id)  
...
Redis:del(TheKmaz.."Kmaz:Lock:Join"..msg_chat_id)  
...
Redis:del(TheKmaz.."Kmaz:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(TheKmaz.."Kmaz:Lock:tagservr"..msg_chat_id)  
...
Redis:del(TheKmaz.."Kmaz:lockpin"..msg_chat_id)  
...
Redis:del(TheKmaz.."Kmaz:Lock:edit"..msg_chat_id) 
...
Redis:del(TheKmaz.."Kmaz:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(TheKmaz..'Kmaz:'..lock..msg_chat_id)    
end
...
Redis:hset(TheKmaz.."Kmaz:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(TheKmaz.."Kmaz:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(TheKmaz.."Kmaz:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(TheKmaz.."Kmaz:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(TheKmaz.."Kmaz:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(TheKmaz.."Kmaz:Lock:Link"..msg_chat_id)  
...
Redis:set(TheKmaz.."Kmaz:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(TheKmaz.."Kmaz:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(TheKmaz.."Kmaz:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(TheKmaz.."Kmaz:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(TheKmaz.."Kmaz:Lock:User:Name"..msg_chat_id)  
...
Redis:set(TheKmaz.."Kmaz:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(TheKmaz.."Kmaz:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(TheKmaz.."Kmaz:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(TheKmaz.."Kmaz:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(TheKmaz.."Kmaz:Lock:hashtak"..msg_chat_id)  
...
Redis:set(TheKmaz.."Kmaz:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(TheKmaz.."Kmaz:Lock:Cmd"..msg_chat_id)  
...
Redis:set(TheKmaz.."Kmaz:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(TheKmaz.."Kmaz:Lock:Photo"..msg_chat_id)  
...
Redis:set(TheKmaz.."Kmaz:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(TheKmaz.."Kmaz:Lock:Video"..msg_chat_id)  
...
Redis:set(TheKmaz.."Kmaz:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(TheKmaz.."Kmaz:Lock:Animation"..msg_chat_id)  
...
Redis:set(TheKmaz.."Kmaz:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(TheKmaz.."Kmaz:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(TheKmaz.."Kmaz:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(TheKmaz.."Kmaz:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(TheKmaz.."Kmaz:Lock:geam"..msg_chat_id)  
...
Redis:set(TheKmaz.."Kmaz:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(TheKmaz.."Kmaz:Lock:Audio"..msg_chat_id)  
...
Redis:set(TheKmaz.."Kmaz:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(TheKmaz.."Kmaz:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(TheKmaz.."Kmaz:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(TheKmaz.."Kmaz:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(TheKmaz.."Kmaz:Lock:vico"..msg_chat_id)  
...
Redis:set(TheKmaz.."Kmaz:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(TheKmaz.."Kmaz:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(TheKmaz.."Kmaz:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(TheKmaz.."Kmaz:Lock:Sticker"..msg_chat_id)  
...
Redis:set(TheKmaz.."Kmaz:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(TheKmaz.."Kmaz:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(TheKmaz.."Kmaz:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(TheKmaz.."Kmaz:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(TheKmaz.."Kmaz:Lock:forward"..msg_chat_id)  
...
Redis:set(TheKmaz.."Kmaz:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(TheKmaz.."Kmaz:Lock:Document"..msg_chat_id)  
...
Redis:set(TheKmaz.."Kmaz:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(TheKmaz.."Kmaz:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(TheKmaz.."Kmaz:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(TheKmaz.."Kmaz:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(TheKmaz.."Kmaz:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(TheKmaz.."Kmaz:Lock:Contact"..msg_chat_id)  
...
Redis:set(TheKmaz.."Kmaz:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(TheKmaz.."Kmaz:Lock:Spam"..msg_chat_id)  
...
Redis:set(TheKmaz.."Kmaz:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(TheKmaz.."Kmaz:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(TheKmaz.."Kmaz:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(TheKmaz.."Kmaz:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(TheKmaz.."Kmaz:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(TheKmaz.."Kmaz:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(TheKmaz.."Kmaz:Group:Link"..msg_chat_id) 
if GetLink then
...
Redis:setex(TheKmaz.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(TheKmaz.."Kmaz:Status:Welcome"..msg_chat_id) then
...
Redis:del(TheKmaz.."Kmaz:Welcome:Group"..msg_chat_id) 
...
Redis:setex(TheKmaz.."Kmaz:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(TheKmaz.."Kmaz:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(TheKmaz.."Kmaz:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(TheKmaz.."Kmaz:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheKmaz.."Kmaz:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(TheKmaz.."Kmaz:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(TheKmaz.."Kmaz:Filter:Group:"..v..msg_chat_id)  
Redis:srem(TheKmaz.."Kmaz:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(TheKmaz.."Kmaz:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(TheKmaz..'Kmaz:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(TheKmaz..'Kmaz:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(TheKmaz.."Kmaz:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(TheKmaz.."Kmaz:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(TheKmaz.."Kmaz:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(TheKmaz.."Kmaz:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(TheKmaz.."Kmaz:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(TheKmaz.."Kmaz:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(TheKmaz.."Kmaz:Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(TheKmaz.."Kmaz:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(TheKmaz.."Kmaz:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(TheKmaz.."Kmaz:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(TheKmaz.."Kmaz:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(TheKmaz.."Kmaz:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(TheKmaz.."Kmaz:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(TheKmaz.."Kmaz:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(TheKmaz.."Kmaz:Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(TheKmaz.."Kmaz:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TheKmaz.."Kmaz:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(TheKmaz.."Kmaz:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(TheKmaz.."Kmaz:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(TheKmaz.."Kmaz:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(TheKmaz.."Kmaz:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(TheKmaz.."Kmaz:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(TheKmaz.."Kmaz:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(TheKmaz.."Kmaz:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(TheKmaz.."Kmaz:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(TheKmaz.."Kmaz:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(TheKmaz.."Kmaz:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(TheKmaz..'Kmaz:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(TheKmaz..'Kmaz:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(TheKmaz..'Kmaz:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد رسائلك هنا *~ '..(Redis:get(TheKmaz..'Kmaz:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد التعديلات هنا *~ '..(Redis:get(TheKmaz..'Kmaz:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد جهاتك المضافه هنا *~ '..(Redis:get(TheKmaz.."Kmaz:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(TheKmaz.."Kmaz:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
᥀︙ارسل الان النص
᥀︙يمكنك اضافه :
...
Redis:del(TheKmaz.."Kmaz:Set:Id:Group"..msg.chat_id)
...
Redis:del(TheKmaz.."Kmaz:DevelopersQ:Groups") 
...
Redis:del(TheKmaz.."Kmaz:Developers:Groups") 
...
Redis:del(TheKmaz.."Kmaz:TheBasics:Group"..msg_chat_id) 
...
Redis:del(TheKmaz.."Kmaz:Originators:Group"..msg_chat_id) 
...
Redis:del(TheKmaz.."Kmaz:Managers:Group"..msg_chat_id) 
...
Redis:del(TheKmaz.."Kmaz:Addictive:Group"..msg_chat_id) 
...
Redis:del(TheKmaz.."Kmaz:Distinguished:Group"..msg_chat_id) 
...
Redis:del(TheKmaz.."Kmaz:BanAll:Groups") 
...
Redis:del(TheKmaz.."Kmaz:BanGroup:Group"..msg_chat_id) 
...
Redis:del(TheKmaz.."Kmaz:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(TheKmaz.."Kmaz:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(TheKmaz.."Kmaz:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(TheKmaz.."Kmaz:List:Manager"..msg_chat_id)
end
...
for k,v in pairs(list) do
if Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ⌔"
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TheKmaz.."Kmaz:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheKmaz.."Kmaz:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(TheKmaz.."Kmaz:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(TheKmaz.."Kmaz:Add:Rd:Sudo:Gif"..v)   
Redis:del(TheKmaz.."Kmaz:Add:Rd:Sudo:vico"..v)   
Redis:del(TheKmaz.."Kmaz:Add:Rd:Sudo:stekr"..v)     
Redis:del(TheKmaz.."Kmaz:Add:Rd:Sudo:Text"..v)   
Redis:del(TheKmaz.."Kmaz:Add:Rd:Sudo:Photo"..v)
Redis:del(TheKmaz.."Kmaz:Add:Rd:Sudo:Video"..v)
Redis:del(TheKmaz.."Kmaz:Add:Rd:Sudo:File"..v)
Redis:del(TheKmaz.."Kmaz:Add:Rd:Sudo:Audio"..v)
Redis:del(TheKmaz.."Kmaz:Add:Rd:Sudo:video_note"..v)
Redis:del(TheKmaz.."Kmaz:List:Rd:Sudo")
end
...
text = "\n📝︙قائمة ردود المطور \n— — — — — — — — —\n"
for k,v in pairs(list) do
if Redis:get(TheKmaz.."Kmaz:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Sudo:File"..v) then
db = "ملف ⌔"
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(TheKmaz.."Kmaz:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TheKmaz.."Kmaz:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheKmaz.."Kmaz:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(TheKmaz.."Kmaz:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheKmaz.."Kmaz:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheKmaz.."Kmaz:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheKmaz.."Kmaz:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(TheKmaz.."Kmaz:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheKmaz..'Kmaz:GetTexting:DevTheKmaz'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheKmaz..'Kmaz:Texting:DevTheKmaz')
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙ تم حذف كليشه المطور')
end
if text == 'المطور' or text == 'مطور' then
local TextingDevTheKmaz = Redis:get(TheKmaz..'Kmaz:Texting:DevTheKmaz')
if TextingDevTheKmaz then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevKmaz,"md",true)  
else
...
{
{text = '.َ ‹ 𝗦𝗼𝘂𝗿𝗰𝗲 𝙍𝘼𝙐𝙈𝙊  ⁦⁦.𖨬', url = "https://t.me/EKKKK6"}
},
}
...
{
{text = '༄ Developer', url = "https://t.me/EKKKK5"},{text = ' ༄ Exp Source .', url = "https://t.me/EKKKK7"}
},
{
{text = ' ༄ Tws 𝙍𝘼𝙐𝙈𝙊 〠', url = "https://t.me/EKKKK3bot"}
},
{
...
Redis:setex(TheKmaz.."Kmaz:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheKmaz.."Kmaz:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(TheKmaz.."Kmaz:Name:Bot") or "راومو") then
local NamesBot = (Redis:get(TheKmaz.."Kmaz:Name:Bot") or "راومو")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
"لتــلح دا احجي ويه بنات راومو بعدين اجاوبك",
...
x = x + 1
Redis:srem(TheKmaz..'Kmaz:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,TheKmaz)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*᥀︙البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(TheKmaz..'Kmaz:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(TheKmaz..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(TheKmaz..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(TheKmaz..'Kmaz:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(TheKmaz.."Kmaz:Game:Smile"..msg.chat_id,SM)
...
Redis:set(TheKmaz.."Kmaz:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(TheKmaz.."Kmaz:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(TheKmaz.."Kmaz:Status:Games"..msg.chat_id) then
Redis:del(TheKmaz.."Kmaz:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(TheKmaz.."Kmaz:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(TheKmaz.."Kmaz:Status:Games"..msg.chat_id) then
Redis:del(TheKmaz.."Kmaz:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(TheKmaz.."Kmaz:Game:Reflection"..msg.chat_id,name)
...
Redis:set(TheKmaz.."Kmaz:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(TheKmaz.."Kmaz:Game:Difference"..msg.chat_id,name)
...
Redis:set(TheKmaz.."Kmaz:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(TheKmaz.."Kmaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(TheKmaz.."Kmaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(TheKmaz.."Kmaz:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(TheKmaz.."Kmaz:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(TheKmaz.."Kmaz:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(TheKmaz.."Kmaz:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'مز','ميمز')
Redis:set(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(TheKmaz.."Kmaz:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
if text == '/start' then
Redis:sadd(TheKmaz..'Kmaz:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(TheKmaz.."Kmaz:Start:Bot") then
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(TheKmaz.."Kmaz:Name:Bot") or "راومو")..
...
data = {
{
{text = '᥀ السورس .', url = 't.me/EKKKK6'},{text = '᥀ لتنصيب بوت .', url = 't.me/EKKKK5'}, 
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheKmaz.."Kmaz:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(TheKmaz.."Kmaz:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheKmaz.."Kmaz:Start:Bot") 
...
if not msg.ControllerBot then
if Redis:get(TheKmaz.."Kmaz:TwaslBot") and not Redis:sismember(TheKmaz.."Kmaz:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(TheKmaz.."Kmaz:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(TheKmaz.."Kmaz:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(TheKmaz..'Kmaz:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'᥀︙تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(TheKmaz..'Kmaz:BaN:In:Tuasl',Info_User)  
...
Redis:srem(TheKmaz.."Kmaz:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(TheKmaz..'*'..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(TheKmaz.."Kmaz:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheKmaz.."Kmaz:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(TheKmaz.."Kmaz:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheKmaz.."Kmaz:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(TheKmaz.."Kmaz:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheKmaz.."Kmaz:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(TheKmaz.."Kmaz:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheKmaz.."Kmaz:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(TheKmaz.."Kmaz:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheKmaz.."Kmaz:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(TheKmaz.."Kmaz:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheKmaz.."Kmaz:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(TheKmaz.."Kmaz:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheKmaz.."Kmaz:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(TheKmaz.."Kmaz:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheKmaz.."Kmaz:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(TheKmaz.."Kmaz:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheKmaz.."Kmaz:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(TheKmaz.."Kmaz:Lock:tagservr"..data.message.chat_id) then
...
if Message_Edit.sender.user_id == TheKmaz then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(TheKmaz..'Kmaz:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(TheKmaz.."Kmaz:Lock:edit"..data.chat_id) then
...
Redis:incrby(TheKmaz.."Kmaz:Num:Add:Games"..ChatId..IdUser, 1)  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheKmaz.."Kmaz:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheKmaz.."Kmaz:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheKmaz.."Kmaz:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheKmaz.."Kmaz:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheKmaz.."Kmaz:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheKmaz.."Kmaz:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheKmaz.."Kmaz:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(TheKmaz.."Kmaz:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheKmaz..'Kmaz:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(TheKmaz.."Kmaz:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"᥀︙تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheKmaz.."Kmaz:SilentGroup:Group"..ChatId) 
